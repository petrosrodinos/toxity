    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === 'scan' &&
            'bg-accent text-accent-foreground font-mono uppercase tracking-[0.08em] text-[13px] font-semibold shadow-[0_4px_14px_color-mix(in_oklch,var(--accent)_35%,transparent)] ring-1 ring-inset ring-[color-mix(in_oklch,var(--accent-foreground)_22%,transparent)] hover:brightness-105 active:scale-[0.98]',
